...
("the_coast", "the coast"),
  ...
  ("adimi_tool_immortal_all", "{s1} made everyone {reg5?immortal:mortal}."),
  ("adimi_tool_immortal_a_player", "{s1} made {s2} {reg5?immortal:mortal}."),
  ("adimi_tool_total_fix_all", "{s1} restored everything(HP/Ammo/Shield HP/Horse HP) of all players."),
  ("adimi_tool_total_fix_a_player", "{s1} restored everything(HP/Ammo/Shield HP/Horse HP) of {s2}."),
  ("adimi_tool_freeze_a_player", "{s1} {reg5?freezed:unfreezed} {s2}."),
  ("adimi_tool_freeze_all_players", "{s1} {reg5?freezed:unfreezed} all players."),
  ("adimi_tool_slay_all_bots", "{s1} slayed all bots."),
  ("adimi_tool_slay_all_horses", "{s1} slayed all horses."),
  ("adimi_tool_slay_all", "{s1} slayed everyone."),
  ("adimi_tool_slay_a_player", "{s1} slayed {s2}. {s6}"),
  ("adimi_tool_set_hp_all", "{s1} changed everyone's hitpoints to {reg5}."),
  ("adimi_tool_set_hp_a_player", "{s1} changed {s2}'s hitpoints to {reg5}."),
  ("adimi_tool_set_gold_all", "{s1} changed everyone's gold coins to {reg5}."),
  ("adimi_tool_set_gold_a_player", "{s1} changed {s2}'s gold coins to {reg5}."),
  ("adimi_tool_set_mute_all", "{s1} {reg5?muted:unmuted} everyone."),
  ("adimi_tool_set_mute_a_player", "{s1} {reg5?muted:unmuted} {s2}. {reg5?{s6}:}"),
  ("adimi_tool_fix_a_shield", "{s1} fixed {s2}'s shield."),
  ("adimi_tool_refill_player_ammo", "{s1} refilled {s2}'s ammo."),
  ("adimi_tool_fix_all_shield", "{s1} fixed all shields."),
  ("adimi_tool_refill_all_ammo", "{s1} refilled everyones ammo."),
  ("adimi_tool_teleport_me_to", "{s1} teleported to {s2}."),
  ("adimi_tool_teleport_x_to_me", "{s1} teleported {s2} to {s1}."),
  ("adimi_tool_teleport_all_to_me", "{s1} teleported everyone to {s1}."),
  ("adimi_tool_sm_force_teambalance", "{s1} balanced the teams."),
  ("adimi_tool_sm_spawn_mof", "{s1} spawned the Master of the Field flag!"),
  ("adimi_tool_speed_modifier", "{s1} used the speed modifier function."),
  ("adimi_tool_teleport_custom", "{s1} used the teleport function."),
  ...
  ("adimi_tool_player_joined_gameid", "{s1} joined the server. ({reg1})"),
  ("adimi_tool_player_joined", "{s1} joined the server."),
  ("adimi_tool_player_leave", "{s1} left the server."),
  ("adimi_tool_antitk_auto_warning", "Please avoid team kills."),
  ("adimi_tool_antitk_auto_ban", "{s1} was banned from the server for a hour. Reason: Intense teamkilling."),
  ("adimi_tool_antitk_auto_kick", "{s1} was kicked from the server. Reason: Teamkilling."),
  ("adimi_tool_switch_player_to_team", "{s1} moved {s2} to {reg5?Team 1:Team 2}."),
  ("adimi_tool_switch_player_to_spec", "{s1} moved {s2} to Spectator."),
  ("adimi_tool_switch_player_swap", "{s1} swapped {s2} to the other team."),
...
("adimi_tool_option_1", "{s1} changed to {s5} on {s0}, {s3} vs {s4}."),
("adimi_tool_option_2", "[SETTING]: Maximum number of players set to {reg0} by {s1}."),
("adimi_tool_option_3", "[SETTING]: Number of bots in {reg0?second:first} team set to {reg1} by {s1}."),
("adimi_tool_option_4", "[SETTING]: Valve Anti-Cheat {reg0?enabled:disabled} by {s1}."),
("adimi_tool_option_5", "[SETTING]: Allow ranged friendly fire {reg0?enabled:disabled} by {s1}."),
("adimi_tool_option_6", "[SETTING]: Allow melee friendly fire {reg0?enabled:disabled} by {s1}."),
("adimi_tool_option_7", "[SETTING]: Friendly fire damage self {reg0?set to {reg0}%:disabled} by {s1}."),
("adimi_tool_option_8", "[SETTING]: Friendly fire damage friend {reg0?set to {reg0}%:disabled} by {s1}."),
("adimi_tool_option_9", "[SETTING]: Spectator camera set to {s2} by {s1}."),
("adimi_tool_option_10", "[SETTING]: Control block direction set to {reg0?mouse movement:automatic} by {s1}."),
("adimi_tool_option_11", "[SETTING]: Combat speed set to {s2} by {s1}."),
("adimi_tool_option_12", "[SETTING]: Defender respawn count set to {reg0?{reg0}:unlimited} by {s1}."),
("adimi_tool_option_13", "[SETTING]: Add to official game servers list {reg0?enabled:disabled} by {s1}."),
("adimi_tool_option_14", "[SETTING]: Respawn period set to {reg0} seconds by {s1}."),
("adimi_tool_option_15", "[SETTING]: Map time limit set to {reg0} minutes by {s1}."),
("adimi_tool_option_16", "[SETTING]: Round time limit set to {reg0} seconds by {s1}."),
("adimi_tool_option_17", "[SETTING]: Switch to bot on death {reg0?enabled:disabled} by {s1}."),
("adimi_tool_option_18", "[SETTING]: Team point limit set to {reg0} by {s1}."),
("adimi_tool_option_19", "[SETTING]: Team points gained from flags set to {reg0}% by {s1}."),
("adimi_tool_option_20", "[SETTING]: Points gained for capturing flags {reg0?set to {reg0}:disabled} by {s1}."),
("adimi_tool_option_21", "[SETTING]: Starting gold {reg0?set to {reg0}%:disabled} by {s1}."),
("adimi_tool_option_22", "[SETTING]: Combat gold bonus {reg0?set to {reg0}%:disabled} by {s1}."),
("adimi_tool_option_23", "[SETTING]: Round gold bonus {reg0?set to {reg0}%:disabled} by {s1}."),
("adimi_tool_option_24", "[SETTING]: Server name changed to {s0} by {s1}."),
("adimi_tool_option_25", "[SETTING]: Password changed by {s1}."),
("adimi_tool_option_26", "[SETTING]: Password disabled by {s1}."),
("adimi_tool_option_27", "[SETTING]: Welcome message updated by {s1}."),
("adimi_tool_option_28", "[ADMIN]: {s2} kicked {s3}. {s6}"),
("adimi_tool_option_29", "[ADMIN]: {s2} banned {s3} {reg1?temporary:permanent}. {s6}"),
("adimi_tool_option_30", "[INFORMATION]: You were banned {reg1?temporary:permanent} by {s2}. {s6}"),
("adimi_tool_option_31", "[SETTING]: Poll accept threshold set to {reg0}% by {s1}."),
("adimi_tool_option_32", "[SETTING]: Auto team balance threshold set to {reg0?{reg0}:unlimited} by {s1}."),
("adimi_tool_option_33", "[SETTING]: Bot count limit for polls {reg0?set to {reg0}:disabled} by {s1}."),
("adimi_tool_option_34", "[SETTING]: Allow polls to change factions {reg0?enabled:disabled} by {s1}."),
("adimi_tool_option_35", "[SETTING]: Allow polls to change maps {reg0?enabled:disabled} by {s1}."),
("adimi_tool_option_36", "[SETTING]: Allow polls to kick players {reg0?enabled:disabled} by {s1}."),
("adimi_tool_option_37", "[SETTING]: Allow polls to ban players {reg0?enabled:disabled} by {s1}."),
("adimi_tool_option_38", "[SETTING]: Allow individual banners {reg0?enabled:disabled} by {s1}."),
("adimi_tool_option_39", "[SETTING]: Force minimum armor {reg0?enabled:disabled} by {s1}."),
("adimi_tool_option_40", "[SETTING]: Disallow ranged weapons {reg0?enabled:disabled} by {s1}."),
("adimi_tool_option_41", "[SETTING]: Automatically server message intervall changed to {reg1} by {s1}."),
("adimi_tool_option_42", "[SETTING]: Automatically server message {reg2?activated:deactivated} by {s1}."),
("adimi_tool_option_43", "[SETTING]: Drowning {reg1?activated:deactivated} by {s1}."),
("adimi_tool_option_44", "[SETTING]: Join message {reg1?activated:deactivated} by {s1}."),
("adimi_tool_option_45", "[SETTING]: Leave message {reg1?activated:deactivated} by {s1}."),
("adimi_tool_option_46", "[SETTING]: Horses {reg1?activated:deactivated} by {s1}."),
("adimi_tool_option_47", "[SETTING]: Duel armors {reg1?enabled:disabled} by {s1}."),
("adimi_tool_option_48", "[SETTING]: Kicking {reg1?activated:deactivated} by {s1}."),
("adimi_tool_option_49", "[SETTING]: Weather changed to {s2} by {s1}."),
("adimi_tool_option_50", "[SETTING]: Weather disabled by {s1}."),
...
("adimi_tool_option_55", "[SETTING]: Anti stray horses system {reg1?activated:deactivated} by {s1}."),
("adimi_tool_option_56", "[INFORMATION]: Sorry, you can not choose this class at the moment. Choose another one."),
("adimi_tool_option_57", "[INFORMATION]: You were kicked by {s2}. {s6}"),
("adimi_tool_option_58", "[SETTING]: Infantry troop limit changed to {reg1}% by {s1}."),
("adimi_tool_option_59", "[SETTING]: Ranged troop limit changed to {reg1}% by {s1}."),
("adimi_tool_option_60", "[SETTING]: Cavalry troop limit changed to {reg1}% by {s1}."),
("adimi_tool_option_61", "[SETTING]: Master of the field override {reg1?enabled:disabled} by {s1}."),
("adimi_tool_option_62", "[SETTING]: Weapons and shields {reg1?disabled:enabled} by {s1}."),
("adimi_tool_option_63", "[SETTING]: Mute all loop {reg1?enabled:disabled} by {s1}."),
("adimi_tool_option_64", "[SETTING]: Immortal Mode {reg1?enabled:disabled} by {s1}."),
("adimi_tool_option_65", "[SETTING]: Team switch after {reg2} round(s) {reg1?enabled:disabled} by {s1}."),
("adimi_tool_option_66", "[INFORMATION]: Teams have been auto-switched."),
("adimi_tool_option_67", "[INFORMATION]: {s1} resetted the map."),
("adimi_tool_option_68", "[SETTING]: Troop limit conditions are now {reg1?determined by the percentage of the player amount:determined by the percentage of the slot amount} by {s1}."),
("adimi_tool_option_69", "[INFORMATION]: You can't kick or ban admins."),
("adimi_tool_option_70", "[SETTING]: Hungergames Mode {reg1?activated:deactivated} by {s1}."),
("adimi_tool_option_71", "[INFORMATION]: {s2} {reg0?gave:revoked} streamer status {reg0?to:from} {s1}."),
("adimi_tool_option_72", "[INFORMATION]: You cannot join a team as a streamer."),
...
("adimi_archery_target_hit", "{s1} hit a target. Distance: {reg1} meters."),
...
("adimi_tool_hungergames_players_left", "[INFORMATION]: {reg1} players left."),
("adimi_tool_hungergames_player_won", "[INFORMATION]: {s10} won the round."),
("adimi_tool_hungergames_player_cannot_sign_up", "[INFORMATION]: Unfortunately you cannot sign up for the next Hungergames round --> Too much players!"),
("adimi_tool_hungergames_player_sign_up_in", "[INFORMATION]: You signed up for the next Hungergames round."),
("adimi_tool_hungergames_player_sign_up_out", "[INFORMATION]: You aren't anylonger signed up for the next Hungergames round."),
("adimi_tool_hungergames_gl_start", "[FINAL COUNTDOWN]: Go! Go! Go!"),
("adimi_tool_hungergames", "Hungergames"),
("adimi_tool_hungergames_player_kill", "[INFORMATION]: {s2} killed {s3}! {reg1} players left."),
("adimi_tool_hungergames_player_suicid", "[INFORMATION]: {s3} died! {reg1} players left."),
...
("custom_server_message_1", "Server Message 1"),
("custom_server_message_2", "Server Message 2"),
("custom_server_message_3", "Server Message 3"),
("custom_server_message_4", "Server Message 4"),
("custom_server_message_5", "Server Message 5"),
...
# Komut mesajlari
("adimi_tool_wse_command_message_disable_two_handed_weapons", "Çift elli silahlar KAPATILDI."),
("adimi_tool_wse_command_message_enable_two_handed_weapons", "Çift elli silahlar AÇILDI."),
("adimi_tool_wse_command_message_disable_polearms", "M,zraklar KAPATILDI."),
("adimi_tool_wse_command_message_enable_polearms", "Mizraklar AÇILDI."),
("adimi_tool_wse_command_message_two_handed_status_off", "Çift elli silahlar: KAPALI"),
("adimi_tool_wse_command_message_two_handed_status_on", "Çift elli silahlar: AÇIK"),
("adimi_tool_wse_command_message_polearms_status_off", "Mizraklar: KAPALI"),
("adimi_tool_wse_command_message_polearms_status_on", "Mizraklar: AÇIK"),
("adimi_tool_wse_command_message_permission_denied", "Bu komutu sadece adminler kullanabilir.")
